...
const lang = {
  es: {
    ...
    "drop.edu.sub": "Para escuelas y comunidades",
    "drop.agri": "Agricultura regenerativa",
    "drop.agri.sub": "Producción sustentable",
    "drop.ref": "Reforestación",
    "drop.ref.sub": "Con especies nativas",
    "drop.ali": "Alianzas sociales",
    "drop.ali.sub": "Para organizaciones",
    
    // CAROUSEL 1
    "car1.title": "RESERVA NATURAL \"DON SILVESTRE\"",
    "car1.text": "Protegemos un espacio vital para la biodiversidad en Misiones, promoviendo reforestación nativa, educación ambiental y acción comunitaria para regenerar el Corredor Península Andresito.",
    "car1.btn": "Descubrir cómo ayudar",
    
    // CAROUSEL 2
    "car2.title": "ESCUELAS SUSTENTABLES",
    "car2.text": "Impulsamos una educación ambiental que inspira a nuevas generaciones a vivir la sostenibilidad desde lo cotidiano con talleres, jornadas y experiencias que transforman comunidad y conciencia.",
    "car2.btn": "Conoce más",
    
    // CAROUSEL 3
    "car3.title": "APICULTORES SUSTENTABLES ANDRESITO",
    "car3.text": "Acompañamos a productores locales en prácticas de apicultura responsable que cuidan el ecosistema, fortalecen la economía regional y promueven un desarrollo verdaderamente sostenible.",
    "car3.btn": "Sumate",
  ...
  en: {
    ...
    "drop.edu.sub": "For schools and communities",
    "drop.agri": "Regenerative agriculture",
    "drop.agri.sub": "Sustainable production",
    "drop.ref": "Reforestation",
    "drop.ref.sub": "With native species",
    "drop.ali": "Social alliances",
    "drop.ali.sub": "For organizations",
    
    // CAROUSEL 1
    "car1.title": "\"DON SILVESTRE\" NATURAL RESERVE",
    "car1.text": "We protect a vital space for biodiversity in Misiones, promoting native reforestation, environmental education and community action to regenerate the Península Andresito Corridor.",
    "car1.btn": "Discover how to help",
    
    // CAROUSEL 2
    "car2.title": "SUSTAINABLE SCHOOLS",
    "car2.text": "We promote environmental education that inspires new generations to live sustainability from everyday life with workshops, events and experiences that transform community and awareness.",
    "car2.btn": "Learn more",
    
    // CAROUSEL 3
    "car3.title": "SUSTAINABLE BEEKEEPERS ANDRESITO",
    "car3.text": "We accompany local producers in responsible beekeeping practices that care for the ecosystem, strengthen the regional economy and promote truly sustainable development.",
    "car3.btn": "Join us",
